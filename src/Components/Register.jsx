                ...
                <div className="w-full  font-serif max-w-md p-6 text-black m-auto mx-auto bg-gray-300 rounded-2xl shadow-md dark:bg-gray-800">
                    ...
                    <form onSubmit={handleSignUp}>
                        ...
                        <div className="pb-2">
                            ...
                            <input type="number" name="phone" placeholder="Enter your Number" className="block w-full font-sans px-4 py-2 text-white bg-gray-600 border rounded-lg dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40" />
                        </div>
                        ...
                        <div className='mt-4'>
                            ...
                            <select name='role' defaultValue='defautl' className="select select-ghost w-full bg-gray-600 border rounded-lg text-white ">
                                ...
                                <option className='text-white'>Agent</option>
                            </select>
                        </div>
